        ...
        <div className="create_product">
            ...
            <form onSubmit={handleSubmit}>
                <div className="row">
                    ...
                    <input type="text" name="product_id" id="product_id" placeholder="please enter product id" required
                    value={product.product_id} onChange={handleChangeInput} disabled={onEdit} />
                </div>

                <div className="row">
                    <label htmlFor="title">Title</label>
                    <input type="text" name="title" id="title" placeholder="please enter product title" required
